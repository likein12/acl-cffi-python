...
extern "C" {
    ...
    pll mcf_graph_ll_ll_flow(void *obj, int s, int t){
        return ((mcf_graph_ll_ll*)obj)->flow(s, t);
    }
    pll mcf_graph_ll_ll_flow_with_limit(void *obj, int s, int t, long long flow_limit){
        return ((mcf_graph_ll_ll*)obj)->flow(s, t, flow_limit);
    }
    ...
    mcf_graph_ll_ll_edge mcf_graph_ll_ll_get_edge(void *obj, int i) {return ((mcf_graph_ll_ll*)obj)->get_edge(i);}
